    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if segue.identifier == "ShowDetail" {
            let lifeDetailsViewController = segue.destinationViewController as! LifeDetailsViewController
            
            // Get the cell that generated this segue.
            if let selectedLifeCell = sender as? LifeTableViewCell {
                let indexPath = tableView.indexPathForCell(selectedLifeCell)!
                let selectedLifeItem = lifeItems[indexPath.row]
                lifeDetailsViewController.lifeItem = selectedLifeItem
            }
        }
    }
